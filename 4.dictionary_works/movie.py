...
# print(max(year_count,key=year_conut.get))
# print(max(year_count.values()))
...
# gener_count={}
# for gens in movies:
#     movie_genres=gens.get("genres")
#     for gen in movie_genres:
#         if gen in gener_count:
#             gener_count[gen]+=1
#         else:
#             gener_count[gen]=1
# print(gener_count)
# most_genre=[(v,k) for k,v in gener_count.items() ]
# print(max(most_genre))

## print(max(gener_count,key=gener_count.get))
## print(max(gener_count.values()))
...
# for movie in movies:
#     actor_movie=movie.get("actors")
#     print(actor_movie)
#     if actor_movie in movie_count:
#         movie_count[actor_movie]+=1
#     else:
#         movie_count[actor_movie]=1
# print(movie_count)
...
## 6 movie with  one genre

# one_genre_movie=[movie.get("title") for  movie in movies if len(movie.get("genres"))==1]
# print(one_genre_movie)

## adventure movies

# adventure_movie=[movie.get("title") for movie in movies if "Adventure" in movie.get("genres")]
# print(adventure_movie)


##  movies released  in 2015

# movie_2015= [movie.get("title") for movie in movies if int(movie.get("year"))==2015]
# print(movie_2015)

##

# movie_after_2000= [movie.get("title") for movie in movies if int(movie.get("year"))>2010]
